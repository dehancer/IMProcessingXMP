...
#include "XMP_Const.h"
    ...
    typedef class TXMPUtils <TXMP_STRING_TYPE>    SXMPUtils;
        ...
        #include "client-glue/TXMPMeta_incl.hpp"
        #include "client-glue/TXMPIterator_incl.hpp"
        #include "client-glue/TXMPUtils_incl.hpp"
        #include "client-glue/TXMPFiles_incl.hpp"
    #endif
